    ...
    def spawnManifestazione(self):
        ...
        while not spawn:
            ...
            for n in range(len(self.nodes)):
                if self.nodes[math.floor(n%15)][math.floor(n/15)].roomID == self.nodes[spawnX][spawnY].roomID or self.nodes[spawnX][spawnY].roomID == self.nodes[self.playerTarget.x][self.playerTarget.y].roomID:
                    spawn = False
